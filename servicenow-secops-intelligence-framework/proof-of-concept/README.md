...
This folder houses video demonstrations of the custom scoped application, showing how the framework operates in real time. More walkthrough videos will be added as development continues.
...
[Watch: Security Incident Form Functionality](Security%20Incident%20From%20Functionality(Walkthrough).mp4)
...
**Return to main project:** [ServiceNow SecOps & Automated Intelligence Response Framework](../README.md)
